...
from personal_project.db.base_model import BaseModel
...
class OrderInfo(BaseModel):
    ...
    user = models.ForeignKey('study_resource.users.User', verbose_name='用户', on_delete=models.CASCADE)
    addr = models.ForeignKey('study_resource.users.Address', verbose_name='地址', on_delete=models.CASCADE)
